...
import { createSubscriptionSchema } from "@/lib/validators/subscription"; // Import the schema
...
export default function AddSubscriptionForm({
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      name: "",
      amount: undefined,
      cycle: "Monthly", // Default to Monthly
      nextBillingDate: new Date(), // Default to today
    },
  });
  ...
  async function onSubmit(values: FormData) {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || "Failed to add subscription"
        );
      }
